...
const sprites = "/assets/icons-DuZAVCg4.svg";
...
const linkedin = "shiva-teja-dasi";
const figma = "@shiva017";
const github = "Shiva-017";
...
function _createMdxContent$1(props) {
  ...
  return jsxs(Fragment$1, {
    children: [jsx(_components.hr, {}), "\n", jsx(_components.h2, {
      ...
      children: jsx(_components.code, {
        className: "language-jsx",
        children: "const StyledButton = styled.button`\r\n  border: 0;\r\n  border-radius: 4px;\r\n  padding: 8px 12px;\r\n  font-size: 14px;\r\n  color: dimgrey;\r\n\r\n  ${props =>\r\n    props.primary\r\n      ? css`\r\n          height: 60px;\r\n          background-color: darkslateblue;\r\n        `\r\n      : css`\r\n          height: 40px;\r\n          background-color: whitesmoke;\r\n        `}\r\n`;\n"
      })
    }), "\n", jsx(_components.p, {
      ...
      children: jsx(_components.code, {
        className: "language-jsx",
        children: `function Button({ color, children }) {\r
  return (\r
...
`
      ...
      children: jsx(_components.code, {
        className: "language-jsx",
        children: `// All we need to pass is the value needed by the transform, rather than\r
...
const Carousel = lazy(
  () => import("./index-BGWb-rH6.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-VjPJ1HP-.js").then((module) => ({ default: module.Armor })));
...
const panoramaEd = "/assets/panoramaEd-CKXdq4Cz.png";
const collegeCompare = "/assets/collegecompare-BCa-8cxX.png";
...
const liveChat = "/assets/livechat-ColegBXr.gif";
...
const Earth = lazy(() => import("./earth-jx-u7Vh8.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-jx-u7Vh8.js").then((module) => ({ default: module.EarthSection }))
);
const title$5 = "Shaping the Future of College Admissions";
const description$3 = "As a key developer for PanoramaED, I spearheaded the integration of real-time mentor chats and peer review features. My work streamlined the college comparison process, creating a dynamic platform that connects students with actionable insights and support for better admissions decisions.";
const roles$1 = [
    ...
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(
        ProjectHeader,
        {
          ...
          url: "https://github.com/Shiva-017/PanoramaEd",
          roles: roles$1
        }
      ),
      /* @__PURE__ */ jsx(ProjectSection, { padding: "top", children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsx(
        ...
        {
          raised: true,
          srcSet: isDark ? `${panoramaEd} 1280w, ${panoramaEd} 2560w` : `${panoramaEd} 1280w, ${panoramaEd} 2560w`,
          width: 1280,
          height: 800,
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { children: [
        ...
        /* @__PURE__ */ jsx(ProjectSectionText, { children: "Students worldwide encounter challenges in discovering and comparing colleges due to fragmented information and a lack of multilingual support. The admissions process is often hindered by language barriers, limiting access to reliable, real-time insights and personalized guidance, which can affect decision-making and lead to missed opportunities." })
      ] }) }),
      /* @__PURE__ */ jsx(ProjectSection, { light: isDark, children: /* @__PURE__ */ jsxs(ProjectSectionContent, { children: [
        /* @__PURE__ */ jsx(
          Image$1,
          {
            srcSet: isDark ? `${collegeCompare} 1024w, ${collegeCompare} 2048w` : `${collegeCompare} 1024w, ${collegeCompare} 2048w`,
            width: 1024,
            hright: 800,
        ...
        /* @__PURE__ */ jsxs(ProjectTextRow, { children: [
          /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Enhanced College Discovery Tools" }),
          /* @__PURE__ */ jsx(ProjectSectionText, { children: "We developed a comprehensive platform that consolidates detailed college profiles and comparison features. This approach simplifies the research process, allowing students to easily evaluate institutions based on key criteria like programs, campus facilities, and costs." })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { children: [
        /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Peer Reviews and Posts" }),
        /* @__PURE__ */ jsx(ProjectSectionText, { children: "To provide authentic insights, we integrated a feature for peer reviews and posts. Students can read and contribute real experiences, offering valuable perspectives on campus life and academic environments, which aids in making more informed decisions." })
      ] }) }) }),
        ...
        ProjectSection,
        {
          ...
          children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { width: "full", children: [
            /* @__PURE__ */ jsx(ProjectSectionContent, { width: "full", children: /* @__PURE__ */ jsxs(ProjectTextRow, { width: "s", children: [
              /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Real-Time Mentor Chats" }),
              /* @__PURE__ */ jsx(ProjectSectionText, { children: "Our platform includes a real-time chat feature connecting students with experienced mentors. This enables personalized advice on college selection and application strategies, helping students navigate the admissions process with expert support." })
            ] }) }),
            /* @__PURE__ */ jsx(
              Image$1,
              {
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { children: [
        /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Multilingual Support" }),
        /* @__PURE__ */ jsx(ProjectSectionText, { children: "To address language barriers, we implemented multilingual support across the platform. This feature ensures students from diverse linguistic backgrounds can access and navigate the platform in their preferred language, improving accessibility and user experience." })
      ] }) }) }),
...
async function getPosts() {
  ...
  const posts = await Promise.all(
    Object.entries(modules).map(async ([file, post2]) => {
      ...
      const text2 = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": () => import("./articles.hello-world-CTWUyren.js"), "../articles.modern-styling-in-react.mdx": () => import("./articles.modern-styling-in-react-DzL0K8_s.js") }), `../articles.${slug}.mdx`);
...
function ArticlesPost({ slug, frontmatter, timecode: timecode2, index: index2 }) {
  ...
  const reduceMotion = useReducedMotion();
  const { title: title2, abstract, date: date2, featured, banner: banner2 } = frontmatter;
  useEffect(() => {
...
const home$2 = "/assets/taskHome-Bdtnx-mL.png";
const uml = "/assets/uml-WGQhLopI.png";
const uml2 = "/assets/uml2-CE95Ofib.png";
const tasks = "/assets/Tasks-8gBvX8PY.png";
...
const title$4 = "TaskMaster: Efficient Task Management with JavaFX";
const description$2 = "A JavaFX-based app for creating, managing, and tracking tasks, structured with MVC architecture and rooted in object-oriented design.";
...
function Articles() {
  const { frontmatter, timecode: timecode2 } = useLoaderData();
  return /* @__PURE__ */ jsx(MDXProvider, { components: postMarkdown, children: /* @__PURE__ */ jsx(Post, { ...frontmatter, timecode: timecode2, children: /* @__PURE__ */ jsx(Outlet, {}) }) });
}
...
async function action({ context, request }) {
  ...
  fetch("https://api.mailjet.com/v3.1/send", requestOptions).then((response) => response.text()).then((result) => console.log(result)).catch((error2) => console.log("error", error2));
  return json({ success: true });
}
const Contact = () => {
  const errorRef = useRef();
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-Kt52CrwR.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const profileImg = "/assets/profile-PS_0w_nI.jpg";
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: "I’m Shiva Teja , pursuing a Master’s in Software Engineering Systems at Northeastern University. My work includes full-stack development, cloud computing, and UX design. I leverage my skills in Java, JavaScript, and Python to build and optimize applications. Check out my portfolio to see the tools I use." }),
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: "In my free time, I explore tech trends, learn new programming languages, and work on innovative projects. Feel free to reach out if you want to discuss opportunities or collaborate!" })
] });
...
const Model = lazy(
  () => import("./index-D6L_fgkz.js").then((module) => ({ default: module.Model }))
);
...
const home$1 = "_home_pb8qs_1";
const styles$2 = {
  home: home$1
};
const home = "/assets/home-LtePgO6n.png";
const rideeasy = "/assets/RE1-Crx3DLMS.png";
const rideeasy2 = "/assets/RE2-D3PIGGQP.png";
const login = "/assets/login-CHKbOy27.png";
const links = () => {
  return [
    {
      rel: "prefetch",
...
const serverManifest = { "entry": { "module": "/assets/entry.client-BulBpwo0.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-DRpNX-cb.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/index-CJ3ad-uR.js", "/assets/visually-hidden-BerPjpgv.js", "/assets/use-spring-CFkEIHd2.js", "/assets/decoder-text-DY31TJ81.js", "/assets/image-ttsIGrsg.js", "/assets/error-oWw3KYgB.js", "/assets/useScrollToHash-B_lQEPHP.js", "/assets/useWindowSize-MDlHk0QV.js", "/assets/config-DWb3-BWr.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/image-cNt8ozvO.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/error-Cq_yTnRj.css", "/assets/root-tKV5qjWr.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-S9Dq4WNs.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BGvdZC4H.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/config-DWb3-BWr.js", "/assets/image-ttsIGrsg.js", "/assets/meta-CzkfKvLk.js", "/assets/useParallax-DOYzs7aL.js", "/assets/project-Bf5ZburV.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-Dgt82hGY.css"] }, "routes/projects.smart-sparrow": { "id": "routes/projects.smart-sparrow", "parentId": "root", "path": "projects/smart-sparrow", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BYSlI2vJ.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/config-DWb3-BWr.js", "/assets/image-ttsIGrsg.js", "/assets/meta-CzkfKvLk.js", "/assets/useParallax-DOYzs7aL.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/visually-hidden-BerPjpgv.js", "/assets/project-Bf5ZburV.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/image-cNt8ozvO.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/project-CMTDR1YT.css", "/assets/route-INjNiGZW.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-CyfYDfFK.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js"], "css": [] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-Dj3ZtqoD.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/config-DWb3-BWr.js", "/assets/index-CJ3ad-uR.js", "/assets/visually-hidden-BerPjpgv.js", "/assets/use-spring-CFkEIHd2.js", "/assets/meta-CzkfKvLk.js", "/assets/decoder-text-DY31TJ81.js", "/assets/divider-3TT8zZCX.js", "/assets/image-ttsIGrsg.js", "/assets/useWindowSize-MDlHk0QV.js", "/assets/date-DvyCAN0s.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/divider-BGrE333F.css", "/assets/image-cNt8ozvO.css", "/assets/route-Cl8BF6JV.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-Bz5uJ2H2.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/config-DWb3-BWr.js", "/assets/image-ttsIGrsg.js", "/assets/meta-CzkfKvLk.js", "/assets/useParallax-DOYzs7aL.js", "/assets/slice-app-placeholder-BfRsQMSa.js", "/assets/project-Bf5ZburV.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-Cvnrim9f.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js?client-route=1", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DWRmKx4-.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/config-DWb3-BWr.js", "/assets/divider-3TT8zZCX.js", "/assets/meta-CzkfKvLk.js", "/assets/image-ttsIGrsg.js", "/assets/useParallax-DOYzs7aL.js", "/assets/useScrollToHash-B_lQEPHP.js", "/assets/clamp-e7DugykH.js", "/assets/date-DvyCAN0s.js", "/assets/list-DKISn4Im.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/divider-BGrE333F.css", "/assets/meta-CErneW72.css", "/assets/image-cNt8ozvO.css", "/assets/list-Bzmr24nT.css", "/assets/route-CIB4zeEr.css"] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CUTDHq6S.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/index-CJ3ad-uR.js", "/assets/visually-hidden-BerPjpgv.js", "/assets/use-spring-CFkEIHd2.js", "/assets/config-DWb3-BWr.js", "/assets/decoder-text-DY31TJ81.js", "/assets/divider-3TT8zZCX.js", "/assets/meta-CzkfKvLk.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/divider-BGrE333F.css", "/assets/meta-CErneW72.css", "/assets/route-CKif1uL8.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CTLxYtNo.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/config-DWb3-BWr.js", "/assets/index-CJ3ad-uR.js", "/assets/visually-hidden-BerPjpgv.js", "/assets/use-spring-CFkEIHd2.js", "/assets/slice-app-placeholder-BfRsQMSa.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/meta-CzkfKvLk.js", "/assets/decoder-text-DY31TJ81.js", "/assets/image-ttsIGrsg.js", "/assets/useScrollToHash-B_lQEPHP.js", "/assets/divider-3TT8zZCX.js", "/assets/useWindowSize-MDlHk0QV.js", "/assets/route-CaB0lZhB.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/image-cNt8ozvO.css", "/assets/divider-BGrE333F.css", "/assets/route-D3R5eEKe.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DfYYGHUm.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/config-DWb3-BWr.js", "/assets/image-ttsIGrsg.js", "/assets/meta-CzkfKvLk.js", "/assets/useParallax-DOYzs7aL.js", "/assets/list-DKISn4Im.js", "/assets/project-Bf5ZburV.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-CErneW72.css", "/assets/list-Bzmr24nT.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-DZeEc7Bh.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-CuA5yjHf.js?client-route=1", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-Bapu5xUB.js", "/assets/heading-DYNvZadC.js", "/assets/index-CJ3ad-uR.js", "/assets/visually-hidden-BerPjpgv.js", "/assets/use-spring-CFkEIHd2.js", "/assets/decoder-text-DY31TJ81.js", "/assets/image-ttsIGrsg.js", "/assets/error-oWw3KYgB.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/image-cNt8ozvO.css", "/assets/error-Cq_yTnRj.css"] } }, "url": "/assets/manifest-cce26576.js", "version": "cce26576" };
