...
const projectsData = [
  { id: 'sidekick', title: 'Sidekick', description: 'AI-powered indoor navigation for visually impaired — sub-3m accuracy without GPS, voice-guided with Gemini AI.', image: sidekickImg, category: 'AI & ML', tags: ['React Native', 'Gemini AI', 'WebSocket'], link: 'https://github.com/shivateja-ab/sidekick-brain' },
  { id: 'researchgpt', title: 'ResearchGPT Pro', description: 'Multi-agent retrieval system indexing 30K+ papers with 7-stage hybrid RAG pipeline and 102K-node citation graph.', image: researchgptImg, category: 'AI & ML', tags: ['LangGraph', 'Neo4j', 'FastAPI'], link: 'http://3.148.70.244/', repoLink: 'https://github.com/Shiva-017/ResearchGPT-Pro' },
  { id: 'college-compare', title: 'College Compare', description: 'Platform to discover, compare, and shortlist colleges worldwide with rich data visualizations.', image: home, category: 'Full Stack', tags: ['React', 'Node.js', 'Education'], link: '/projects/smart-sparrow' },
  { id: 'mail-master', title: 'Mail Master', description: 'AI-powered Gmail assistant using LLMs and a custom Model Context Protocol server.', image: mailmaster, category: 'AI & ML', tags: ['MCP', 'LLM', 'Python'], link: 'https://github.com/Shiva-017/Mail_Master' },
  { id: 'gcp-infra', title: 'GCP Cloud Suite', description: 'Automated cloud infrastructure provisioning with Terraform, Packer, and serverless functions.', image: gcp, category: 'Cloud & DevOps', tags: ['GCP', 'Terraform', 'Packer'], link: 'https://github.com/Shiva-017/webapp/' },
  ...
  { id: 'go-vcs', title: 'Go-VCS', description: 'Git-compatible VCS built in Go with Merkle tree integrity and AI-generated commit messages.', image: govcs, category: 'Systems', tags: ['Go', 'AI', 'Merkle Tree'], link: 'https://github.com/Shiva-017/Go-VCS' },
